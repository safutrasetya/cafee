...
<html lang="en" dir="ltr">
  ...
  <body class="bg-light">
        ...
        <div class="col-sm-12">
          <div class="mx-auto my-3" style="">
            ...
            <ul class="nav justify-content-center nav-pills">
              <li class="nav-item">
                <a class="nav-link active" data-bs-toggle="pill" href="#harian">Harian</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="pill" href="#bulanan">Bulanan</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-bs-toggle="pill" href="#tahunan">Tahunan</a>
              </li>
            </ul>
          </div>
        </div>
    ...
    <div class="tab-content" id="nav-tabContent">
      <div class="tab-pane fade show active" id="harian" role="tabpanel" aria-labelledby="nav-home-tab">
      ...
      <div class="tab-pane fade" id="bulanan" role="tabpanel" aria-labelledby="nav-profile-tab">
        <div class="row justify-content-center pe-2">
          <div class="col-sm-8">
            <div class="mb-3 ps-3">
              <div class="col-sm-auto text-center">
      ...
      <div class="tab-pane fade" id="tahunan" role="tabpanel" aria-labelledby="nav-contact-tab">
        <div class="row justify-content-center pe-2">
          <div class="col-sm-8">
            <div class="mb-3 ps-3">
              <div class="col-sm-auto text-center">
